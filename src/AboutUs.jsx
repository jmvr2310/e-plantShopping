...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Bound2Earth, so you too can feel the heartbeat of the World!</p>
      <p className="about-us-content">
        At Bound2Earth, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Bound2Earth today and experience the 
